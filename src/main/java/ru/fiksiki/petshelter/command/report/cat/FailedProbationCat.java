 ...
 */
@Component
public class FailedProbationCat extends Command {
     ...
     */
    public FailedProbationCat(SendMessageService sendMessageService) {
        super(CommandName.FAILED_PROBATION_CAT);
        this.sendMessageService = sendMessageService;
    }

    /**
     * Executes the FailedProbationCat command with the specified Update.
